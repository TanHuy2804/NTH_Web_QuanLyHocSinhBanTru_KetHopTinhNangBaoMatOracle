Oracle.ManagedDataAccess.EntityFramework Nuget Package Version 12.2.20220118 README
===================================================================================
Release Notes: Oracle Data Provider for .NET, Managed Driver for Entity Framework 6

Juanuary 2022

This README supplements the main ODP.NET 12.2 documentation.
https://docs.oracle.com/cd/E85694_01/index.htm
...
1. Un-GAC any existing ODP.NET for Entity Framework 12.2 versions you have installed. For example, if you 
plan to use only the ODP.NET, Managed Driver for Entity Framework, only un-GAC existing managed ODP.NET for
Entity Framework 12.2 versions then.
...
3. Install the NuGet package from an OTN-downloaded local package source or from nuget.org.
   ...
   official Oracle Data Provider for .NET, Managed Driver for Entity Framework downloads.
...
Installation Changes
====================
The following app/web.config entries are added by including the Oracle.ManagedDataAccess.EntityFramework 
...
Bug Fixes since 12.2.20190115
=============================
Bug 33462044 - MEMORY LEAK OBSERVED WHEN NAE IS USED
